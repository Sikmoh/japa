...
from database.postgresql.db_utils import db_connect
...
def user_model():
    ...
    """
    return "(id SERIAL PRIMARY KEY, email VARCHAR(255), password VARCHAR(255), refresh_token VARCHAR(1024), " \
           "access_role VARCHAR(10), created TIMESTAMP default now(), disabled BOOLEAN, email_verified BOOLEAN, " \
           "logged_in BOOLEAN, " \
