...
class Fares(object):
    ...
    def request_data_async(self, query, departure=None, arrival=None, departure_date=None, adults=None, children=None,
        ...
        if departure:
            urls_append(f"{URL}{query}/{departure}/{arrival}/{departure_date}/{adults}/{children}/{infants}/{cabin}/{currency}")
        else:
    ...
    def request_data_sync(self, query, departure=None, arrival=None, departure_date=None, adults=None, children=None,
                           infants=None, cabin=None, currency=None):
        """
        ...
        try:
            ...
            URL = f"{link}{query}/{departure}/{arrival}/{departure_date}/{adults}/{children}/{infants}/{cabin}/{currency}"
